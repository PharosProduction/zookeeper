...
function create_config() {
    ...
    echo "quorumListenOnAllIPs=true" >> $CONFIG_FILE
    echo "4lw.commands.whitelist=*" >> $CONFIG_FILE
    echo "jute.maxbuffer=0xfffff" >> $CONFIG_FILE
...
function create_jvm_props() {
    ...
    echo "JVMFLAGS=\"-Xmx$HEAP -Xms$HEAP -Djute.maxbuffer=1000000\"" >> $JAVA_ENV_FILE
}
